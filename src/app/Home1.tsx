        ...
        <div>
            <div id="home" className="home">
                <div className="hero-main">
                    <Image className="bg-[50%] bg-cover w-12 h-12 md:w-16 md:h-16 rounded-[9999px]"
                    src={metePhoto}
                    width={500}
                    height={500}
                    quality={100}
                    ...
                    <div className="hero-text">
                        <div>
                            <h1 className="font-bold text-[14px] md:text-[16px] text-[#dce8f4] mb-1">Metin Nabiyev</h1>
                            <p className="text-[12px] md:text-[14px] text-[#C9D1D9]">Front-End developer from Baku, Azerbaijan.</p>
                        </div>
                        <span>
