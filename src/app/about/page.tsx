    ...
    return (
        <div className="relative">
            <div className="aboutBack">
                <h1 className="pt-32 flex justify-center font-semibold text-3xl">
                    My Tech Knowledge
                </h1>
                ...
                <div
                    id="about"
                    className="pt-20 pb-12 md:ml-8 items-center justify-center flex flex-col md:flex-row text-center "
                >
                    <Image
                    ...
                    <div className="aboutText m-2">
                        ...
                        <p>
                            Hello there, its Metin Nabiyev and I&apos;m
                            interested in web programming. I&apos;m 21 years old
                            university student at Atatürk University.
                            <br />
                            <br />
                            My Major is Computer Science and right now I&apos;m
                            at 4th grade. I&apos;m good at React.js, Next.js,
                            TailwindCSS and I&apos;m using all 3 of them to
                            create this portfolio website.
                            <br />I want to be able to create a website on my
                            own from scratch. It&apos;s my first website.
                        </p>
                    </div>
                </div>
            </div>
